...
export default function Hero() {
  return (
    <>
      <section className="hero relative p-0 min-h-full lg:min-h-[90vh] h-full  w-full max-w-5xl lg:max-w-7xl text-base-200 flex flex-col sm:flex-row flex-nowrap justify-start">
